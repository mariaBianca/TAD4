...
class SpaceObject {
	...
	static boolean active;            // Active flag.
	static double  angle;             // Current angle of rotation.
	static double  deltaAngle;        // Amount to change the rotation angle.
	static double  x;              // Current position on screen.
	static double y;
	static double  deltaX;    // Amount to change the screen position.
